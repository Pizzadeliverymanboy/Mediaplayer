...
partial class MediaplayerWindow
{
    ...
    private void InitializeComponent()
    {
        ...
        // tb_volume
        // 
        tb_volume.BackColor = Color.DarkOrange;
        tb_volume.LargeChange = 1;
        tb_volume.Location = new Point(782, 635);
        tb_volume.Maximum = 100;
        tb_volume.Name = "tb_volume";
        tb_volume.Orientation = Orientation.Vertical;
        tb_volume.Size = new Size(56, 199);
        tb_volume.TabIndex = 7;
        tb_volume.TickStyle = TickStyle.Both;
        tb_volume.Value = 50;
        ...
        tscb_audio.MaxDropDownItems = 20;
        ...
        tscb_video.MaxDropDownItems = 20;
        ...
        tscb_album.MaxDropDownItems = 20;
        ...
        lb_current_playlist.Location = new Point(1032, 50);
        ...
        lb_current_playlist.TextAlign = ContentAlignment.MiddleCenter;
        // 
        // lb_playlistid
        // 
